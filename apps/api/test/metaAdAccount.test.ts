...
test("maskAdAccountId masks ad account ID showing only last 4 digits", () => {
  ...
  it("returns customer selected ad account when test mode enabled but customer doesn't match", () => {
    process.env = {
      ...originalEnv,
      META_TEST_MODE: "true",
      META_TEST_CUSTOMER_ID: "test-customer-123",
  ...
  it("returns override ad account when test mode enabled and customer matches", () => {
    process.env = {
      ...originalEnv,
      META_TEST_MODE: "true",
      META_TEST_CUSTOMER_ID: "test-customer-123",
  ...
  it("normalizes ad account ID without act_ prefix", () => {
    process.env = {
      ...originalEnv,
      META_TEST_MODE: "true",
      META_TEST_CUSTOMER_ID: "test-customer-123",
  ...
  it("returns null when no ad account selected and not in test mode", () => {
    process.env = { ...originalEnv };
    delete process.env.META_TEST_MODE;
  ...
  it("returns override even when customer has no selected ad account in test mode", () => {
    process.env = {
      ...originalEnv,
      META_TEST_MODE: "true",
      META_TEST_CUSTOMER_ID: "test-customer-123",
